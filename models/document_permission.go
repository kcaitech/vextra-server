...
type DocumentPermission struct {
	...
	ResourceId     int64          `gorm:"uniqueIndex:unique_index" json:"resource_id"`              // 资源ID，文档ID或文件夹ID？
	GranteeType    GranteeType    `gorm:"default:0; uniqueIndex:unique_index" json:"grantee_type"`  // 受让人类型，0-外部人员，1-内部人员，2-部门
	GranteeId      string         `gorm:"uniqueIndex:unique_index" json:"grantee_id"`               // 受让人ID，用户id?
...
func (model DocumentPermission) GetId() int64 {
	return model.Id
}
