...
func ProjectUp(db *gorm.DB) error {
	...
	if err := db.AutoMigrate(&ProjectPermissionRequests{}); err != nil {
		return err
	}
	return nil
}

func ProjectDown(db *gorm.DB) error {
	if err := db.Migrator().DropTable(&Project{}); err != nil {
		return err
	}
	if err := db.Migrator().DropTable(&ProjectMember{}); err != nil {
		return err
	}
	if err := db.Migrator().DropTable(&ProjectPermissionRequests{}); err != nil {
		return err
	}
	return nil
}
