...
func NewDefaultService(model models.BaseModel) *DefaultService {
	s := DefaultService{
		DBModule: dbModule,
		Model:    model,
	}
...
func (s *DefaultService) Create(modelData models.BaseModel) error {
	// modelData.SetId(id)
	return s.DBModule.DB.Model(s.Model).Create(modelData).Error
}

var ErrRecordNotFound = errors.New("记录不存在")

func (s *DefaultService) Get(modelData models.BaseModel, args ...any) error {
	db := s.DBModule.DB.Model(s.Model)
...
func (s *DefaultService) updates(modelData models.BaseModel, ignoreZero bool, args ...any) (int64, error) {
...
func (s *DefaultService) Updates(modelData models.BaseModel, args ...any) (int64, error) {
...
func (s *DefaultService) UpdatesIgnoreZero(modelData models.BaseModel, args ...any) (int64, error) {
